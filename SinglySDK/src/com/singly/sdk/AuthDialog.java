...
public class AuthDialog
  ...
  /**
   * A listener class used to handle communication with AuthDialog instances.
   * Provides hooks into the redirected url after service authentication.
   */
  public static interface DialogListener {

    /**
     * Called when the authentication with a service completes.
     * 
     * @param url The redirect url from the service.
     */
